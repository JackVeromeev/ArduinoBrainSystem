...
{
	ui8 currentNumber1,   // least significant digit
			currentNumber2;   // most significant digit
	ui8 clockPin1, clockPin2;
	ui8 resetPin1, resetPin2;
	
	// reset digit (if digit, set number) or whole dial (use without params)
	...
	void increment(ui8 digitNumber = 0)
	{
		switch (digitNumber)
		{
...
public:
	...
	TwoNumberDialClass(ui8 _clockPin1, ui8 _clockPin2, ui8 _resetPin1, ui8 _resetPin2)
	{
		this->currentNumber1 = 0;
		this->currentNumber2 = 0;
	...
	ui8 getNumber()
	{
		return (this->currentNumber2) * 10 + (this->currentNumber1);
	}
